...
import { getAdmins, deleteAdmin, Admin } from '../utils/api';
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-emerald-500">Admins</h1>
        <motion.button
      ...
      <div className="bg-gray-900 rounded-lg shadow-xl overflow-hidden">
        <table className="min-w-full divide-y divide-gray-800">
          ...
          <tbody className="divide-y divide-gray-800">
            {admins.map((admin) => (
              <tr key={admin.id} className="hover:bg-gray-800 transition-colors duration-150">
                <td className="px-6 py-4">
                  <div className="text-gray-200">{admin.username}</div>
                </td>
                <td className="px-6 py-4">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
